...
function addHours(numOfHours, date = new Date())
 { date. setTime(date. getTime() + numOfHours * 60 * 60 * 1000); return date; }

// Set the date we're counting down to
var countDownDate = new Date(addHours(1/120)).getTime();
...
var x = setInterval(function() {
  ...
  var hr=Math.floor((distance%(1000))/(1000*60*60))
...
<div class={`modal fade ${open ? 'show':''}`} id="exampleModalTogglescreenname" aria-hidden="true" aria-labelledby="exampleModalToggleLabel3" tabindex="-1" style={{display:`${open ? 'block':'none'}`}}>
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body" style={{textAlign:"center",color:"black"}}>
      <p>Are You Sure Accept ?</p>

      <div className='d-flex' style={{justifyContent:"space-around"}}>
      <button class="btn btn-success btn-md bg-primary btn-block mt-4" onClick={()=>setOpen(!open)}>No</button>
      <button class="btn btn-success btn-md bg-primary btn-block mt-4" data-bs-target="#exampleModalTogglescreenname122" data-bs-toggle="modal" data-bs-dismiss="modal" onClick={()=>setOpen(!open)}>Yes</button>
    ...
    <div class="container-fluid py-4">
            ...
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8" style={{cursor:"pointer"}}>
                  <a href="#workchart">
                  <div class="numbers" id="dropdownMenuButton"  aria-expanded="false">
                    
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Workchart</p>
                    <h5 class="font-weight-bolder mb-0">
                      See New Offer
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                  <i class="bi bi-globe" style={{fontSize:"20px"}}></i>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                  <i class="bi bi-clipboard-minus" style={{fontSize:"20px"}}></i>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row my-4" id="workchart">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">User_To</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Notification_Id</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">TimeCounter</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <span  style={{cursor:"pointer"}}>
                        <select style={{height:"30px"}} onChange={(e)=>handledropdown(e)} disabled={dd} >
                          <option>
                            Pending
                          </option>
                          <option>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold" id="demo"></span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold" id="demo">Expired</span>
          ...
          <div class="card h-100 z-index-2">
            <div class="card-body p-3">
              <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                <div class="chart">
                <ResponsiveContainer width="100%" aspect={3} class="chart-canvas" height="300">
          ...
          <div class="card h-100 z-index-2">
            ...
            <div class="card-body p-3">
              <div class="chart">
                ...
                <ResponsiveContainer width="100%" aspect={3} class="chart-canvas" height="400">
                <LineChart data={pdata} margin={{ right: 30 }}>
                    <CartesianGrid />
                    <XAxis dataKey="name" 
                        interval={'preserveStartEnd'} />
